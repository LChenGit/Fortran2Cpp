...
struct MulchType {
    float MULCHMASS = 0.0f;
    float MULCHCOVER = 0.0f;
    float MULCHTHICK = 0.0f;
    float MULCHWAT = 0.0f;
    float MULCH_AM = 0.0f;
    float MUL_EXTFAC = 0.0f;
    float MULCHEVAP = 0.0f; // Assuming this is the target variable to store the result
};
