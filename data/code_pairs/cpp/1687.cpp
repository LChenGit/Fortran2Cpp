...
void fd(const std::vector<double>& data_in, std::vector<double>& df_out, int N, double dx, int kd) {
    ...
    cd1[3] = 1.0 / 280.0;  // Corresponds to cd1(-4) in Fortran
    cd1[4] = -4.0 / 105.0; // Corresponds to cd1(-3)
    cd1[5] = 0.2;          // Corresponds to cd1(-2)
    cd1[6] = -0.8;         // Corresponds to cd1(-1)
    cd1[7] = 0.0;          // Corresponds to cd1(0)
    cd1[8] = 0.8;          // Corresponds to cd1(1)
    cd1[0] = -0.2;         // Corresponds to cd1(2)
    cd1[1] = 4.0 / 105.0;  // Corresponds to cd1(3)
    cd1[2] = -1.0 / 280.0; // Corresponds to cd1(4)
