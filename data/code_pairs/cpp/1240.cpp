...
// Define the great_rsd function to perform some operation; here it sums two numbers.
...
void test_great_rsd(double a, double b, double expected) {
    ...
    if (std::fabs(result - expected) < 1e-6) { // Using floating-point comparison with a tolerance
