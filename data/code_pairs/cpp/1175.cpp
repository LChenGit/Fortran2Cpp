...
// Function templates to mimic Fortran polymorphism
template <typename T>
...
void times2boo(const T& value, int& resi, float& resr) {
    // Defined below with specializations
}

// Specialization for integer
template <>
void times2boo(const int& value, int& resi, float&) {
    resi = value * 2;
}

// Specialization for float
template <>
void times2boo(const float& value, int&, float& resr) {
    resr = value * 2.0f;
}
