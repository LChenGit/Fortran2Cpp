...
int main() {
    ...
    std::vector<std::vector<float>> AR(NM, std::vector<float>(NM, 0.0f)); // Initialize to test values
    std::vector<std::vector<float>> AI(NM, std::vector<float>(NM, 0.0f)); // Initialize to test values
    ...
    // Manipulate AR, AI to simulate realistic test conditions
    AR[2][1] = 2.0f; // Adjusting for 0-based indexing
    AI[3][2] = 2.0f; // Adjusting for 0-based indexing
