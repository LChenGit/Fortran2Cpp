program main
    ...
    real::a, b, c
    real, parameter :: expected_a = 0.0, expected_b = -0.0425162911, expected_c = -0.0628442615
...
contains
    ...
    subroutine test_calculations(a, b, c, expected_a, expected_b, expected_c, tolerance)
        ...
        if (abs(a - expected_a) < tolerance .and. abs(b - expected_b) < tolerance .and. abs(c - expected_c) < tolerance) then
            print *, "Test passed."
        else
            print *, "Test failed."
